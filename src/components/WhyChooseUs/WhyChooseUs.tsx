    ...
    return (
        ...
        <div className={styles.cards}>
          ...
          <div className={styles.card}>
            ...
            <p>Our managers are ready to answer your questions at any time of the day.</p>
          </div>
          <div className={styles.card}>
            <img src="res/star.png" alt="brand" />
            <h3>Top brand in the world</h3>
            <p>Our reputation based on our customer reviews makes us the most popular car dealership</p>
          </div>
        </div>
      </div>
    );
